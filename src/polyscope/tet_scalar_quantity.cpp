...
TetScalarQuantity::TetScalarQuantity(std::string name, TetMesh& mesh_, std::string definedOn_,
                                             DataType dataType_)
    : Quantity<TetMesh>(name, mesh_, true), dataType(dataType_), definedOn(definedOn_) {
...
TetVertexScalarQuantity::TetVertexScalarQuantity(std::string name, std::vector<double> values_,
