...
axisAlignedCluster(TetMesh& t, std::vector<size_t> activeVertices,
    ...
    std::vector<std::vector<size_t>> lowerClusters =
        axisAlignedCluster(t, lower, clusterSize);
    std::vector<std::vector<size_t>> upperClusters =
        axisAlignedCluster(t, upper, clusterSize);

    lowerClusters.insert(lowerClusters.end(), upperClusters.begin(),
                         upperClusters.end());
